...
import csv
with open("./data/NLPCC/test_converted.json", "r", encoding="utf-8") as f:
...
try:
    ...
    model.load_state_dict(torch.load("Randeng_NLPCC_02_02_22_34.pth", map_location=device))
    model.eval()
    ...
    with open(output_file, "a", encoding="utf-8", newline='') as f:
        ...
        # 写入评估结果
        writer.writerow(["Randeng_NLPCC_02_02_22_34", avg_bleu, avg_meteor, avg_rouge_l])
